...
import { ThemeProvider, ColorModeProvider } from '@agriffis/xstyled-styled-components'
import App from './App'
...
```js
import React from 'react'
import { useColorMode } from '@agriffis/xstyled-styled-components'
...
```js
import React from 'react'
import { getColorModeInitScriptElement } from '@agriffis/xstyled-styled-components'
