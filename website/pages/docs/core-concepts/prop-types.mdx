...
`@agriffis/xstyled-prop-types` exposes a utility to generate prop-types from a system prop utility.

## Installation

```
npm i @agriffis/xstyled-prop-types
```
...
import { compose, space, color } from '@agriffis/xstyled-system'
import { getSystemPropTypes } from '@agriffis/xstyled-prop-types'
