...
- `@agriffis/xstyled-styled-components`: 15.4kb gzipped ([see on Bundlephobia](https://bundlephobia.com/result?p=@agriffis/xstyled-styled-components@2.2.3))
- `@agriffis/xstyled-emotion`: 15.7kb gzipped ([see on Bundlephobia](https://bundlephobia.com/result?p=@agriffis/xstyled-emotion@2.2.3))
...
This benchmark measures the speed of [@agriffis/xstyled-system](https://www.npmjs.com/package/@agriffis/xstyled-system) vs [styled-system](https://www.npmjs.com/package/styled-system).

```js
@agriffis/xstyled-system x 431,828 ops/sec ±1.06% (86 runs sampled)
...
@agriffis/xstyled-styled-components x 17,538 ops/sec ±2.10% (87 runs sampled)
...
@agriffis/xstyled-styled-components x 1,009,807 ops/sec ±1.13% (86 runs sampled)
Fastest is @agriffis/xstyled-styled-components,styled-components
```
