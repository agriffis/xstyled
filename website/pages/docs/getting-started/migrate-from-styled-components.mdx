...
`@agriffis/xstyled-styled-components` is a drop-in replacement for `styled-components`. You can safely replace `styled-components` by `@agriffis/xstyled-styled-components`.
    ...
    [
      "babel-plugin-styled-components",
      {
        "topLevelImportPaths": [
          ...
          "@agriffis/xstyled-styled-components/no-tags",
          "@agriffis/xstyled-styled-components/native",
          "@agriffis/xstyled-styled-components/primitives"
        ],
      }
    ]
  ]
...
module.exports = {
  ...
  // Other macros config
  styledComponents: {
    importModuleName: '@agriffis/xstyled-styled-components',
  },
}
```
