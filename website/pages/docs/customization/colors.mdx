...
```js
import { defaultTheme } from '@agriffis/xstyled-...'
...
```js
import { defaultTheme, generateHexAlphaVariants } from '@agriffis/xstyled-...'
...
```js
import { defaultTheme, aliasColor } from '@agriffis/xstyled-...'
