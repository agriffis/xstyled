...
```js
import { createX, fontSize } from '@agriffis/xstyled-...'
...
```js
import { createX, compose, fontSize, fontWeight } from '@agriffis/xstyled-...'
import { borderInline } from './border-inline'
...
```js
import { createX, typography } from '@agriffis/xstyled-...'
import { borderInline } from './border-inline'
