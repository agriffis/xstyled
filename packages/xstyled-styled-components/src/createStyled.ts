...
import { BoxElements } from '@agriffis/xstyled-core'
import { string } from '@agriffis/xstyled-util'
import { StyleGenerator, StyleGeneratorProps, Theme } from '@agriffis/xstyled-system'
import scStyled, {
  StyledConfig,
