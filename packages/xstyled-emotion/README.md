...
[![License](https://img.shields.io/npm/l/@agriffis/xstyled-emotion.svg)](https://github.com/gregberge/xstyled/blob/master/LICENSE)
[![npm package](https://img.shields.io/npm/v/@agriffis/xstyled-emotion/latest.svg)](https://www.npmjs.com/package/@agriffis/xstyled-emotion)
[![npm downloads](https://img.shields.io/npm/dm/@agriffis/xstyled-emotion.svg)](https://www.npmjs.com/package/@agriffis/xstyled-emotion)
...
[![Small size](https://img.badgesize.io/https://unpkg.com/@agriffis/xstyled-emotion/dist/xstyled-emotion.min.js?compression=gzip)](https://unpkg.com/@agriffis/xstyled-emotion/dist/xstyled-emotion.min.js)

```bash
npm install @agriffis/xstyled-emotion @emotion/react @emotion/styled
```
...
```js
import { x } from '@agriffis/xstyled-emotion'
